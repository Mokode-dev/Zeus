...
// 无硬件演示：虚拟 Omron FINS PLC 应答 FINS/UDP Memory Area Read/Write。
// 现场联调时，把 AddVirtualChannel 换成 AddUdpClient("fins-link", "192.168.250.1", 9600) 即可。
...
Console.WriteLine($"FINS 点表：temperature = {temperature:F1}, running = {running}");
