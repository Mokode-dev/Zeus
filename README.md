...
- 📡 **Protocols** — Custom frames, Modbus RTU/TCP, Mitsubishi MC 1E/3E/4E Binary/ASCII, Siemens S7 TCP, Omron FINS UDP/TCP, Omron Host Link ASCII, Panasonic MEWTOCOL-COM, and Allen-Bradley EtherNet/IP CIP, with virtual slave/PLC support
